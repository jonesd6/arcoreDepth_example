...
public class SharedCameraActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    // Use 320 * 240 for Samsung Note 10+, hardcode for now.
    private static final int DEPTH_WIDTH = 320;
    private static final int DEPTH_HEIGHT = 240;
    ...
    public TOF_ImageReader tof_imageReader = new TOF_ImageReader();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        depthCamera = new DepthCamera(this, tof_imageReader);
        depthCamera.openBackDepthCamera();
    ...
    public void onDrawFrameARCore() throws CameraNotAvailableException {
        ...
        if (TOF_available && tof_imageReader.frameCount == 0) return;

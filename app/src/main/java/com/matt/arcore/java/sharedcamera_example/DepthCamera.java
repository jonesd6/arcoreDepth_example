...
public class DepthCamera extends CameraDevice.StateCallback {
    ...
    private TOF_ImageReader imageAvailableListener;

    public DepthCamera(Context context, TOF_ImageReader tof_imageReader) {
        this.context = context;
        cameraManager = (CameraManager)context.getSystemService(Context.CAMERA_SERVICE);
        imageAvailableListener = tof_imageReader;
        previewReader = ImageReader.newInstance(TOF_ImageReader.WIDTH,
                TOF_ImageReader.HEIGHT, ImageFormat.DEPTH16,2);
    ...
    public void openBackDepthCamera() {
        ...
        Log.d("DEPTH_CAMERA_ID", cameraId);
        openCamera(cameraId);
    }
